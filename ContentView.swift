...
struct ContentView: View {
    ...
    func launchScript() {
        ...
        // Ensure the script file is in your app bundle:
        guard let scriptPath = Bundle.main.path(forResource: "cleanup", ofType: "sh") else {
            scriptOutput.append("cleanup.sh not found in bundle resources.\n")
            return
        }
